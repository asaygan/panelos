...
import { PanelCabinetsSection } from "@/components/panels/panel-cabinets-section";
...
type TabId = "overview" | "cabinets" | "schematics" | "components" | "revisions" | "qr" | "activity";

const TABS: { id: TabId; label: string; icon: Parameters<typeof Icon>[0]["name"]; count?: number }[] = [
  { id: "overview", label: "Overview", icon: "layout-grid" },
  { id: "cabinets", label: "Cabinets", icon: "box" },
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, overflow: "auto", padding: 16 }}>
        ...
        {tab === "cabinets" && <PanelCabinetsSection panelId={id} />}
