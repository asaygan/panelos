"""B/W thermal printable label.

Thin wrapper: provides the default plain/print v2 layout and routes all drawing
through the shared SVG renderer + rasterizer (pixel parity with web).
"""
...
from panelos_api.labels.layout import default_print_layout
...
class PrintBwRenderer:
    """High-contrast B/W tag rendered from the default plain v2 layout."""
